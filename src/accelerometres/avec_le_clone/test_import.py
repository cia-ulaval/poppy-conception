...
accelero = mpu6050.MPU6050(a_bus=1, a_address=0x68)


# Define a function to read the sensor data
def read_sensor_data():
    # Read the accelerometer values
    accelerometer_data = accelero.get_acceleration()
    # Read the gyroscope values
    gyroscope_data = accelero.get_rotation()
    # Read temp
...
for i in range(50):
    accels, angles = read_sensor_data()
    print(angles.x, angles.y, angles.y)
    x, y, z = accels.x, accels.y, accels.z
    # print(x, y, z)
    time.sleep(0.3)
